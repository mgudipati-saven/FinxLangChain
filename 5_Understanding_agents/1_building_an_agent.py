...
# agent_executor.invoke("Can you recommend me a zombie game from the year 2022?")
...
agent_executor_w_memory.invoke("Can you recommend me a zombie game from the year 2022?")
agent_executor_w_memory.invoke("Can you give me more information on that first game?")
